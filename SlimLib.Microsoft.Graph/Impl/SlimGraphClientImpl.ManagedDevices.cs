...
namespace SlimLib.Microsoft.Graph
{
    partial class SlimGraphClientImpl
    {
        ...
        {
            var link = ODataLinkBuilder.BuildLink(options, $"deviceManagement/managedDevices/{deviceID}/syncDevice");
        ...
        {
            var link = ODataLinkBuilder.BuildLink(options, $"deviceManagement/managedDevices/{deviceID}/windowsDefenderScan");
        ...
        {
            var link = ODataLinkBuilder.BuildLink(options, $"deviceManagement/managedDevices/{deviceID}");
        ...
        GraphArrayOperation<JsonDocument> ISlimGraphManagedDevicesClient.GetManagedDeviceDetectedAppsAsync(IAzureTenant tenant, Guid deviceID, ListRequestOptions? options, CancellationToken cancellationToken)
        {
            var nextLink = ODataLinkBuilder.BuildLink(options, $"deviceManagement/managedDevices/{deviceID}/detectedApps");

            return new(this, tenant, HttpMethod.Get, nextLink, options, default, static doc => doc);
        }

        GraphArrayOperation<Guid[]> ISlimGraphManagedDevicesClient.GetManagedDeviceUsersAsync(IAzureTenant tenant, Guid deviceID, ListRequestOptions? options, CancellationToken cancellationToken)
        {
            var nextLink = ODataLinkBuilder.BuildLink(options, $"deviceManagement/managedDevices/{deviceID}/users");
        ...
        {
            var link = ODataLinkBuilder.BuildLink(options, $"deviceManagement/managedDeviceOverview");

            return new(this, tenant, HttpMethod.Get, link, options, default, static doc => doc);
        }

        GraphArrayOperation<JsonDocument> ISlimGraphManagedDevicesClient.GetManagedDevicesAsync(IAzureTenant tenant, ListRequestOptions? options, CancellationToken cancellationToken)
        {
            var nextLink = ODataLinkBuilder.BuildLink(options, "deviceManagement/managedDevices");

            return new(this, tenant, HttpMethod.Get, nextLink, options, default, static doc => doc);
        }

        GraphArrayOperation<JsonDocument> ISlimGraphManagedDevicesClient.GetManagedDeviceEncryptionStatesAsync(IAzureTenant tenant, ListRequestOptions? options, CancellationToken cancellationToken)
        {
            var nextLink = ODataLinkBuilder.BuildLink(options, "deviceManagement/managedDeviceEncryptionStates");
        ...
        {
            var link = ODataLinkBuilder.BuildLink(options, $"deviceManagement/windowsAutopilotDeviceIdentities/{identityID}");

            return new(this, tenant, HttpMethod.Get, link, options, default, static doc => doc);
        }

        GraphArrayOperation<JsonDocument> ISlimGraphManagedDevicesClient.GetWindowsAutopilotDeviceIdentitiesAsync(IAzureTenant tenant, ListRequestOptions? options, CancellationToken cancellationToken)
        {
            var nextLink = ODataLinkBuilder.BuildLink(options, "deviceManagement/windowsAutopilotDeviceIdentities");
        ...
        {
            var link = ODataLinkBuilder.BuildLink(options, $"deviceManagement/importedWindowsAutopilotDeviceIdentities/{identityID}");

            return new(this, tenant, HttpMethod.Get, link, options, default, static doc => doc);
        }

        GraphArrayOperation<JsonDocument> ISlimGraphManagedDevicesClient.ImportWindowsAutopilotDeviceIdentityAsync(IAzureTenant tenant, ICollection<JsonObject> identities, InvokeRequestOptions? options, CancellationToken cancellationToken)
        {
            var nextLink = ODataLinkBuilder.BuildLink(options, "deviceManagement/importedWindowsAutopilotDeviceIdentities/import");
        ...
        {
            var link = ODataLinkBuilder.BuildLink(options, $"deviceManagement/managedDevices/{deviceID}/wipe");

            return new(this, tenant, HttpMethod.Post, link, options, JsonSerializer.SerializeToUtf8Bytes(data));
        }

        GraphArrayOperation<JsonDocument> ISlimGraphManagedDevicesClient.GetDeviceHealthScriptsAsync(IAzureTenant tenant, ListRequestOptions? options, CancellationToken cancellationToken)
        {
            var nextLink = ODataLinkBuilder.BuildLink(options, "deviceManagement/deviceHealthScripts");
        ...
        {
            var link = ODataLinkBuilder.BuildLink(options, $"deviceManagement/deviceHealthScripts/{deviceHealthScriptId}");
            return new(this, tenant, HttpMethod.Get, link, options, default, static doc => doc);
        }
        ...
        {
            var link = ODataLinkBuilder.BuildLink(options, "deviceManagement/deviceHealthScripts");
        ...
        {
            var link = ODataLinkBuilder.BuildLink(options, $"deviceManagement/deviceHealthScripts/{deviceHealthScriptId}/assign");
            return new(this, tenant, HttpMethod.Post, link, options, JsonSerializer.SerializeToUtf8Bytes(data));
        }
        GraphArrayOperation<JsonDocument> ISlimGraphManagedDevicesClient.GetDeviceHealthScriptAssignmentsAsync(IAzureTenant tenant, string deviceHealthScriptId, ListRequestOptions? options, CancellationToken cancellationToken)
        {
            var nextLink = ODataLinkBuilder.BuildLink(options, $"deviceManagement/deviceHealthScripts/{deviceHealthScriptId}/assignments");

            return new(this, tenant, HttpMethod.Get, nextLink, options, default, static doc => doc);
        }
        GraphArrayOperation<JsonDocument> ISlimGraphManagedDevicesClient.GetDeviceAndAppManagementAssignmentFiltersAsync(IAzureTenant tenant, ListRequestOptions? options, CancellationToken cancellationToken)
        {
            var nextLink = ODataLinkBuilder.BuildLink(options, "deviceManagement/assignmentFilters");
        ...
        {
            var link = ODataLinkBuilder.BuildLink(options, $"deviceManagement/assignmentFilters/{deviceAndAppManagementAssignmentFilterId}");
            return new(this, tenant, HttpMethod.Get, link, options, default, static doc => doc);
        }
        ...
        {
            var link = ODataLinkBuilder.BuildLink(options, "deviceManagement/assignmentFilters");
            return new(this, tenant, HttpMethod.Post, link, options, JsonSerializer.SerializeToUtf8Bytes(data), static doc => doc);
        }
        ...
        {
            var link = ODataLinkBuilder.BuildLink(options, $"deviceManagement/deviceHealthScripts/{deviceHealthScriptId}/getRemediationHistory");
            return new(this, tenant, HttpMethod.Get, link, options, default, static doc => doc);
        }
        ...
        {
            var link = ODataLinkBuilder.BuildLink(options, $"deviceManagement/deviceHealthScripts/{deviceHealthScriptId}/runSummary");
            return new(this, tenant, HttpMethod.Get, link, options, default, static doc => doc);
        }
        ...
        {
            var link = ODataLinkBuilder.BuildLink(options, $"deviceManagement/managedDevices/{deviceID}/initiateOnDemandProactiveRemediation");

            return new(this, tenant, HttpMethod.Post, link, options, JsonSerializer.SerializeToUtf8Bytes(data));
        }
        GraphArrayOperation<JsonDocument> ISlimGraphManagedDevicesClient.GetRemoteActionAuditsAsync(IAzureTenant tenant, ListRequestOptions? options, CancellationToken cancellationToken)
        {
            var nextLink = ODataLinkBuilder.BuildLink(options, $"deviceManagement/remoteActionAudits");
            return new(this, tenant, HttpMethod.Get, nextLink, options, default, static doc => doc);
        }
        GraphArrayOperation<JsonDocument> ISlimGraphManagedDevicesClient.GetDeviceHealthScriptStatesAsync(IAzureTenant tenant, Guid deviceID, ListRequestOptions? options, CancellationToken cancellationToken)
        {
            var nextLink = ODataLinkBuilder.BuildLink(options, $"deviceManagement/managedDevices/{deviceID}/deviceHealthScriptStates");
            return new(this, tenant, HttpMethod.Get, nextLink, options, default, static doc => doc);
        }
        GraphArrayOperation<JsonDocument> ISlimGraphManagedDevicesClient.GetDeviceRunStatesAsync(IAzureTenant tenant, string deviceHealthScriptId, ListRequestOptions? options, CancellationToken cancellationToken)
        {
            var nextLink = ODataLinkBuilder.BuildLink(options, $"deviceManagement/deviceHealthScripts/{deviceHealthScriptId}/deviceRunStates");
            return new(this, tenant, HttpMethod.Get, nextLink, options, default, static doc => doc);
        }
        ...
        {
            var link = ODataLinkBuilder.BuildLink(options, $"deviceManagement/managedDevices/{deviceID}/rotateLocalAdminPassword");
        ...
        {
            var link = ODataLinkBuilder.BuildLink(options, $"deviceManagement/managedDevices/{deviceID}/retrieveMacOSManagedDeviceLocalAdminAccountDetail");
        ...
        {
            var link = ODataLinkBuilder.BuildLink(options, $"deviceManagement/managedDevices/{deviceID}/getFileVaultKey");
        ...
        {
            var link = ODataLinkBuilder.BuildLink(options, $"deviceManagement/managedDevices/{deviceID}/rotateFileVaultKey");
        ...
        {
            var link = ODataLinkBuilder.BuildLink(options, $"deviceManagement/managedDevices/{deviceID}/rotateBitLockerKeys");
